...
function diaDeLaSemana(numeroDeDia) {
  ...
  if (numeroDeDia[i]===1 || numeroDeDia[i]=== 7){ return "Es fin de semana";}
  return "dia laboral";
} 
...
function mesesDelAño(array) {
  ...
  if (Narray.length< 3){return "No se encontraron los meses perdidos";}
  else { return Narray;}
